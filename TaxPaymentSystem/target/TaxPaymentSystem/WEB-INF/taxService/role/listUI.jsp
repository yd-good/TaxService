...
<head>
	...
	function doSelectAll(){
  	...
  	//新增
  	function doAdd(){
  		document.forms[0].action = "${basePath}taxService/role_addUI.action";
  		document.forms[0].submit();
  	}
  	//编辑
  	function doEdit(id){
  		document.forms[0].action = "${basePath}taxService/role_editUI.action?role.roleId=" + id;
  		document.forms[0].submit();
  	}
  	//删除
  	function doDelete(id){
  		document.forms[0].action = "${basePath}taxService/role_delete.action?role.roleId=" + id;
  		document.forms[0].submit();
  	}
  	//批量删除
  	function doDeleteAll(){
  		document.forms[0].action = "${basePath}taxService/role_deleteSelected.action";
  		document.forms[0].submit();
  	}
    var url="${basePath}taxService/role_listUI.action";
    </script>
</head>
                    ...
                    <table width="100%" border="0">
                        <tr class="t_tit">
                            ...
                            <tr <s:if test="#st.odd">bgcolor="f8f8f8"</s:if> >
                                ...
                                <td align="center"><s:property value="roleStatus==1?'有效':'无效'"/></td>
                                <td align="center">
