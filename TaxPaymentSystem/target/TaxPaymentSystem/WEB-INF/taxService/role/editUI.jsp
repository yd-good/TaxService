...
<form id="form" name="form" action="${basePath }taxService/role_edit.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:radio list="#{'1':'有效','0':'无效'}" name="role.roleStatus"/></td>
        </tr>
    </table>
