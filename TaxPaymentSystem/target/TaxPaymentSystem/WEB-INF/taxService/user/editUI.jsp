...
<head>
    ...
    <script type="text/javascript">
        var fResult=true;
        function updateDiVerify(){
            var account=$("#account").val();//获取账号值
            if (account!=""){
              $.ajax({
...
<form id="form" name="form" action="${basePath}taxService/user_edit.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
...
<%--            创建两个部门，使用struts标签加载--%>
        ...
        <tr>
            ...
            <td><s:textfield name="user.account" id="account" onchange="updateDiVerify()"/>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:checkboxlist list="#roleList" name="userRoleIds" listKey="roleId" listValue="roleName"></s:checkboxlist></td>
        </tr>
        <tr>
    ...
    <div class="tc mt20">
        <input type="button" class="btnB2" value="保存" onclick="updateSubmit()"/>
        &nbsp;&nbsp;&nbsp;&nbsp;
