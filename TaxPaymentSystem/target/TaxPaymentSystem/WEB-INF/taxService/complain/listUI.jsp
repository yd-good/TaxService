...
<script type="text/javascript">
    var url="${basePath}taxService/complain_listUI.action";
    function doSearch(){
        document.forms[0].action=url;
        document.forms[0].submit();
    }
    function doDeal(id) {
        document.forms[0].action="${basePath}/taxService/complain_dealUI.action?complain.compId="+id;
        document.forms[0].submit();
    }
    function doAnnualStatistic() {
            document.forms[0].action = "${basePath}/taxService/complain_newAnnualStatisticChartUI.action";
            document.forms[0].submit();
    }
</script>
