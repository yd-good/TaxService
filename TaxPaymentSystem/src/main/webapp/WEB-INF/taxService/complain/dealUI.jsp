...
<form id="form" name="form" action="${basePath}/taxService/complain_deal.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:date name="complain.compTime" format="yyyy-MM-dd HH:mm"></s:date></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:property value="complain.compContent" escapeHtml="flase"/></td>
        </tr>
